...
$(document).ready(function() {
    ...
    manageBrandTable = $("#manageBrandTable").DataTable({
        'ajax': '/ipheya/core/sub/php_action/fetchBrand.php',
        'order': []
    });
    ...
    $("#submitBrandForm").unbind('submit').bind('submit', function()
    {
        ...
        if (brandStatus == "") {
            $("#brandStatus").after('<p class="text-danger">Please select a brand status</p>');
...
function editBrands(brandId = null) {
    if (brandId) {
        ...
        $.ajax({
            url: '/ipheya/core/sub/php_action/fetchSelectedBrand.php',
            type: 'post',
            ...
            success: function(response) {
                    ...
                    $('#editBrandForm').unbind('submit').bind('submit', function() {
                        ...
                        if (brandStatus == "") {
                            $("#editBrandStatus").after('<p class="text-danger">Please select a brand status</p>');
        ...
        $.ajax({
            ...
            success: function(response) {
                    ...
                    $("#removeBrandBtn").unbind('click').bind('click', function() {
                        ...
                        $.ajax({
                            url: '/ipheya/core/sub/php_action/removeBrand.php',
                            type: 'post',
                            data: { brandId: brandId },
                            dataType: 'json',
                            success: function(response) {
