      ...
      <div class="container collapse navbar-collapse" id="main-menu">
        <div class="navbar-header">
            <ul class="nav navbar-nav ">
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-target="">Bussiness Perfomance<span class="caret"></span></a>
                <ul class="dropdown-menu" role="menu">
                  <li><a  href="cashflow.php"><span class="glyphicon glyphicon-piggy-bank"></span> Money Management</a></li>
                  <li><a  href="programs.php"><span class="glyphicon glyphicon-briefcase"></span> Programs and Project managent</a></li>
                </ul>
              </li>
              <li class="dropdown">
        ...
        <div class="navbar-header navbar-right">
            <ul class="nav navbar-nav">
              <li>
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?=$_SESSION['Manager'];?> <span class="caret"></span></a>
                <ul class="dropdown-menu" role="menu">
