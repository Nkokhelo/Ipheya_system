            ...
            <div class='col-xs-11 b'>
              <div>
                ...
                <ul class="nav nav-tabs" role="tablist">
                  <li role="presentation" class="active"><a href="#list"  aria-controls="home" role="tab" data-toggle="tab">All Overdue Debts</a></li>
                      ...
                      <div class="col-xs-12">
                        ...
                        <?php } else{ ?>
                          ...
                          <table class="table table-bordered table-hover" id="expensetable">
                            <thead>
                              <tr><th style="50px">ID</th><th style="100px">Name</th><th style="width:520px">Description</th><th style="150px"> Price</th></tr>
                            </thead>
                            <tbody>
                              <?=$e_trans?>
                            </tbody>
                            <tfoot>
                              <tr><td colspan="3" align="right"><b>Overall Debts Price</b></td><td align="right">R <?= number_format($tot_exp,2,","," ")?></td></tr>
                            </tfoot>
                        </table>
                        <?php }?>
                      </div> 
