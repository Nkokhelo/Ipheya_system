<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 " id="sidebar">
  ...
  <ul>
    ...
    <li class="<?=((isset($profile_page))?'selected':'');?>"></li>
    <li class="<?=((isset($request_page))?'selected':'');?>"><a href="../client/request.php"><span class="glyphicon glyphicon-plus"></span> Requests</a></li>
