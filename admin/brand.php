        ...
        <div class='row'>
            ...
            <div class="col-xs-6">
              ...
              <div class="col-xs-11 b">
                <h2>Brand Management</h2><hr class="bhr">
                  <div class="col-xs-12">
                  ...
                  <div class="col-xs-12">
                    <div class="col-xs-offset-4 col-xs-4">
                      <button class="btn btn-default btn-block" data-toggle="modal" data-target="#addBrandModel"> <i class="glyphicon glyphicon-plus-sign"></i> Add Brand </button>
                    </div> <!-- /div-action -->
                  </div>
                  ...
                  <div class="modal fade" id="addBrandModel" tabindex="-1" role="dialog">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <form class="form-horizontal" id="submitBrandForm" action="/ipheya/core/sub/php_action/createBrand.php" method="POST">
                  ...
                  <div class="modal fade" id="editBrandModel" tabindex="-1" role="dialog">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <form class="form-horizontal" id="editBrandForm" action="/ipheya/core/sub/php_action/editBrand.php" method="POST">
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
